# Project 3 - *Coder Twitter*

**Coder Twitter** is an android app that allows a user to view his Twitter timeline and post a new tweet. The app utilizes [Twitter REST API](https://dev.twitter.com/rest/public).
...
* [x] User can **compose and post a new tweet**
  * [x] User can click a “Compose” icon in the Action Bar on the top right -- I Use FAB
...
<img src='coderTwitter.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
